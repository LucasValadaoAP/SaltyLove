        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    ...
                    textbutton _("Disabilitado") action Preference("rollback side", "disable")
                ...
                vbox:
                    style_prefix "check"
                    label _("Pular")
                    textbutton _("Texto Despercebido") action Preference("skip", "toggle")
                    textbutton _("Escolhas Posteriores") action Preference("after choices", "toggle")
...
screen keyboard_help():
    ...
    hbox:
        label _("Enter")
        text _("Avança diálogos e interage com a interface.")

    hbox:
        label _("Espaço")
        text _("Avança diálogos sem selecionar escolhas.")

    hbox:
        label _("Setas do teclado")
        text _("Navegam pela interface do jogo.")

    hbox:
        label _("Esc")
        text _("Acessa o menu principal.")

    hbox:
        label _("Ctrl")
        text _("Pula diálogos enquanto pressionado.")

    hbox:
        label _("Tab")
        text _("Alterna o salto dos diálogos.")

    hbox:
        label _("Page Up")
        text _("Volta para diálogos anteriores.")

    hbox:
        label _("Page Down")
        text _("Avança para diálogos posteriores.")
